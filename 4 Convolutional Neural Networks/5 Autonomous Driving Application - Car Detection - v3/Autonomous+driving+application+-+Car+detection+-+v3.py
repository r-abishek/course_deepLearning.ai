...
    """
    ...
    inter_area = abs(max((yi2 - yi1), 0) * max((xi2 - xi1), 0))
    ### END CODE HERE ###    
...
out_scores, out_boxes, out_classes = predict(sess, "1.png")


# In[21]:

out_scores, out_boxes, out_classes = predict(sess, "2.jpg")
...
out_scores, out_boxes, out_classes = predict(sess, "4.jpg")
